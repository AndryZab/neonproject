...
#pragma warning restore 0649
        ...
        private float lastDirectionChangeTime; // Add this variable at the top of your class

        private void CalculateInput(PointerEventData eventData)
        {
            float currentTime = Time.time;
            float timeSinceLastChange = currentTime - lastDirectionChangeTime;
            ...
            // Apply the delay before changing direction
            if (timeSinceLastChange >= 0.05f) // Adjust the delay time as needed
            {
